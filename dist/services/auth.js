...
const registerNewUser = ({ email, password, name }) => __awaiter(void 0, void 0, void 0, function* () {
    const checkIs = yield user_1.default.findOne({ email }); //Verificamos si hay existe algun email parecido
    if (checkIs)
        return "ALREADY_USER";
    const passHash = yield (0, bcrypt_handle_1.encrypt)(password); //TODO 12345678
...
const loginUser = ({ email, password }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = (0, jwt_handle_1.generateToken)(checkIs.email); //generams el token con nuestro estrin email 
    const data = {
        token,
        user: checkIs,
    };
