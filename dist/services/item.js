...
const insertCar = (item) => __awaiter(void 0, void 0, void 0, function* () {
    const responseInsert = yield item_1.default.create(item); // esperamos a que se cree segun el esquema ya definido
...
const updateCar = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const responseItem = yield item_1.default.findOneAndUpdate({ _id: id }, data, {
